...
Vamos a utilizar [prodigal](https://github.com/hyattpd/Prodigal) para predecir las proteinas:
...
Okay, ahora vamos a utilizar [kofam_scan](https://github.com/takaram/kofam_scan) para anotar las proteinas.
...
### Anotacion con [InterproScan](https://interproscan-docs.readthedocs.io/en/latest/)
